                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <p class="mb-0 font-13 text-success"><i class="bi bi-caret-up-fill"></i> 4.6 from last week
                            </p>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <p class="mb-0 font-13 text-danger"><i class="bi bi-caret-down-fill"></i> 2.7 from last week
                            </p>
                        </div>
                ...
                <div class="card-body">
                    <div class="categories">
                        ...
                        <div class="progress-wrapper">
                            ...
                            <div class="progress" style="height: 6px;">
                                <div class="progress-bar bg-gradient-royal" role="progressbar" style="width: 45%;">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-body p-0">
                    <div class="best-product p-2 mb-3">
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{ asset('assets/admin/assets/images/products/02.png') }}" alt="">
                                </div>
                                <div class="product-info">
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{ asset('assets/admin/assets/images/products/03.png') }}" alt="">
                                </div>
                                <div class="product-info">
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{ asset('assets/admin/assets/images/products/04.png') }}" alt="">
                                </div>
                                <div class="product-info">
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{ asset('assets/admin/assets/images/products/05.png') }}" alt="">
                                </div>
                                <div class="product-info">
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{ asset('assets/admin/assets/images/products/06.png') }}" alt="">
                                </div>
                                <div class="product-info">
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{ asset('assets/admin/assets/images/products/07.png') }}" alt="">
                                </div>
                                <div class="product-info">
                        ...
                        <div class="best-product-item">
                            <div class="d-flex align-items-center gap-3">
                                <div class="product-box border">
                                    <img src="{{ asset('assets/admin/assets/images/products/08.png') }}" alt="">
                                </div>
                                <div class="product-info">
            ...
            <div class="card radius-10 w-100">
                ...
                <div class="top-sellers-list p-2 mb-3">
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{ asset('assets/admin/assets/images/avatars/avatar-1.png') }}" class="rounded-circle"
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{ asset('assets/admin/assets/images/avatars/avatar-2.png') }}" class="rounded-circle"
                            width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{ asset('assets/admin/assets/images/avatars/avatar-3.png') }}" class="rounded-circle"
                            width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{ asset('assets/admin/assets/images/avatars/avatar-4.png') }}" class="rounded-circle"
                            width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{ asset('assets/admin/assets/images/avatars/avatar-5.png') }}" class="rounded-circle"
                            width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{ asset('assets/admin/assets/images/avatars/avatar-6.png') }}" class="rounded-circle"
                            width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{ asset('assets/admin/assets/images/avatars/avatar-7.png') }}" class="rounded-circle"
                            width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{ asset('assets/admin/assets/images/avatars/avatar-8.png') }}" class="rounded-circle"
                            width="50" height="50" alt="">
                        <div>
                    ...
                    <div class="d-flex align-items-center gap-3 sellers-list-item">
                        <img src="{{ asset('assets/admin/assets/images/avatars/avatar-9.png') }}" class="rounded-circle"
                            width="50" height="50" alt="">
                        <div>
                            <h6 class="mb-0">David Buckley</h6>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="product-box border">
                                        <img src="{{ asset('assets/admin/assets/images/products/11.png') }}" alt="">
                                    </div>
                                    <div class="product-info">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="product-box border">
                                        <img src="{{ asset('assets/admin/assets/images/products/17.png') }}" alt="">
                                    </div>
                                    <div class="product-info">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-3">
                                    <div class="product-box border">
                                        <img src="{{ asset('assets/admin/assets/images/products/10.png') }}" alt="">
                                    </div>
                                    <div class="product-info">
