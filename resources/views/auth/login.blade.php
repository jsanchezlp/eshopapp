...
@section('breadcrumb')
    @include('home.partials.breadcrumb', ['title' => 'algo'])
@endsection
            		...
            		<div class="padding_eight_all bg-white">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            ...
                            <div class="form-group mb-3">
                                <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" placeholder="Your Email" value="{{ old('email') }}" required autocomplete="email" autofocus>
